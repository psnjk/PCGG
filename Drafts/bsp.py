...
def create_image( grid):
    img = Image.new("RGB", (512, 512), (67, 67, 67))
    offset = 512/64
    ...
    for i in range(64):
        for j in range(64):
            if grid[i][j] == '.':
                draw.rectangle(((j*offset, i*offset), (offset+j*offset, offset+i*offset)), (150, 237, 199))
    return img
...
a = RLDungeonGenerator(64,64)
a.generate_map()
create_image(a.dungeon).save('bsp.png')